  ...
  books.push(
    {
      ...
      features: ["10 years past questions", "All subjects covered", "Marking schemes included", "Practical guides", "Expert solutions", "Bonus tips"],
      tableOfContents: ["Mathematics", "English", "Physics", "Chemistry", "Biology", "Economics", "Government", "Literature", "Solutions", "Practical Guide"],
    },
    {
      id: "neco-complete",
      ...
      features: ["10 years past questions", "All subjects covered", "Marking schemes", "Expert solutions"],
      tableOfContents: ["Mathematics", "English", "Physics", "Chemistry", "Biology", "Economics", "Government", "Literature", "Solutions"],
    },
    {
      id: "jamb-math",
      ...
      features: ["500+ solved problems", "All formulas included", "Shortcut methods", "Practice tests", "Expert tips"],
      tableOfContents: ["Algebra", "Calculus", "Geometry", "Trigonometry", "Statistics", "Probability", "Practice Tests", "Solutions"],
    },
    {
      id: "jamb-english",
      ...
      features: ["Comprehension mastery", "Lexis & structure", "Oral English", "Essay writing", "Practice tests"],
      tableOfContents: ["Comprehension", "Lexis", "Structure", "Oral English", "Essay Writing", "Practice Tests", "Solutions"],
    },
    {
      id: "ielts-pack",
      ...
      features: ["All 4 modules covered", "10 practice tests", "Band score strategies", "Speaking tips", "Writing templates"],
      tableOfContents: ["Reading Module", "Writing Module", "Speaking Module", "Listening Module", "Practice Test 1-10", "Band Score Guide", "Tips & Strategies"],
    },
    {
      id: "sat-pack",
      ...
      features: ["Math complete guide", "Verbal complete guide", "Practice tests", "Score strategies", "Calculator tips"],
      tableOfContents: ["Heart of Algebra", "Problem Solving", "Passport to Advanced Math", "Reading", "Writing & Language", "Essay", "Practice Tests", "Solutions"],
    },
    {
      id: "master-bundle",
      ...
      rating: 5.0,
      reviews: 89,
      downloadLink: "https://drive.google.com/drive/folders/YOUR_MASTER_FOLDER?usp=sharing",
      imageUrl: PRODUCT_IMAGES["master-bundle"],
      features: ["All 23 universities", "10+ years per school", "8,000+ pages", "Detailed solutions", "Post-UTME bonus", "Lifetime updates"],
      tableOfContents: ["UNILAG", "UI", "OAU", "UNIBEN", "UNN", "ABU", "UNILORIN", "UNIJOS", "UNIPORT", "UNIABUJA", "LASU", "OOU", "EKSU", "DELSU", "AAU", "UNIZIK", "FUTA", "FUTMINNA", "FUTO", "UNIUYO", "UNICAL", "BUK", "UDUSOK", "Post-UTME Guide"],
    },
    {
      id: "mega-bundle",
      ...
      rating: 5.0,
      reviews: 45,
      downloadLink: "https://drive.google.com/drive/folders/YOUR_MEGA_FOLDER?usp=sharing",
      imageUrl: PRODUCT_IMAGES["mega-bundle"],
      features: ["All 23 UTME schools", "WAEC complete", "NECO complete", "JAMB complete", "IELTS complete", "SAT complete"],
      tableOfContents: ["UTME All Schools", "WAEC", "NECO", "JAMB Math", "JAMB English", "IELTS", "SAT", "Bonus Materials"],
    }
  );
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="flex justify-between mb-2">
                  ...
                  <span className="font-bold">₦{ebook.price.toLocaleString()}</span>
                </div>
                <div className="border-t pt-2 flex justify-between font-bold text-lg">
                  <span>Total</span>
                  <span className="text-[#C9921A]">₦{ebook.price.toLocaleString()}</span>
                </div>
              </div>
              <button
          ...
          {step === "flutterwave" && (
            <div className="text-center space-y-5">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Pay ₦{ebook.price.toLocaleString()} via Flutterwave</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={copyTransactionRef} className="p-1 hover:bg-gray-200 rounded">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button onClick={handlePaymentSuccess} className="bg-green-100 text-green-700 font-semibold py-2.5 rounded-lg hover:bg-green-200 transition-all flex items-center justify-center gap-2">
                  <CheckCircle className="w-4 h-4" /> I Paid
                </button>
                <button onClick={handlePaymentFailed} className="bg-red-100 text-red-700 font-semibold py-2.5 rounded-lg hover:bg-red-200 transition-all flex items-center justify-center gap-2">
          ...
          {step === "success" && (
            <div className="text-center space-y-5">
              ...
              <h4 className="font-heading font-bold text-xl">Payment Successful!</h4>
              <div className="bg-[#25D366]/10 border-2 border-[#25D366] rounded-xl p-5">
                <p className="text-sm text-gray-700 mb-3">Send proof on WhatsApp for instant delivery:</p>
                <a
              ...
              {ebook.downloadLink && (
                ...
                >
                  ...
                  <span className="text-sm font-medium flex-1 text-left">Download {ebook.title}</span>
          ...
          {step === "failed" && (
            <div className="text-center space-y-5">
              ...
              <button onClick={() => setStep("flutterwave")} className="w-full bg-[#1A3C6E] text-white font-semibold py-3 rounded-lg hover:bg-[#142d54]">
                Try Again
              </button>
            </div>
          )}
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-[#1A1A2E] mb-2">eBook Not Found</h2>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-[#1A3C6E] text-white sticky top-0 z-40 shadow-lg">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <button onClick={() => navigate(-1)} className="flex items-center gap-2 hover:bg-white/10 p-2 rounded-lg transition-all">
              <ArrowLeft className="w-5 h-5" />
              <span className="font-heading font-bold">Back</span>
            </button>
            <button onClick={() => navigate("/ebooks")} className="font-heading font-bold hover:bg-white/10 p-2 rounded-lg transition-all">
              All eBooks
            </button>
          </div>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex items-center justify-center">
              <div className={`w-64 h-64 rounded-3xl flex items-center justify-center shadow-2xl overflow-hidden relative ${
                ...
                {!imgError && ebook.imageUrl ? (
                  ...
                  <div className="text-center">
                    <div className="flex justify-center -space-x-4 mb-4">
                      {[0, 1, 2].map((i) => (
                        <div key={i} className="w-14 h-14 bg-white/20 rounded-full border-2 border-white flex items-center justify-center">
                          <BookOpen className="w-7 h-7 text-white" />
                        </div>
                      ))}
                    </div>
                    <span className="text-white font-bold text-2xl">{ebook.badge}</span>
                  </div>
                ) : (
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-white/80 ml-2">{ebook.rating} ({ebook.reviews} reviews)</span>
              </div>
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                <div key={stat.label} className="bg-white rounded-xl p-4 text-center border border-gray-100 shadow-sm">
                  <div className="font-display text-2xl font-bold text-[#1A3C6E]">{stat.value}</div>
            ...
            {/* Features */}
            <div>
              <h3 className="font-heading font-bold text-xl text-[#1A1A2E] mb-4">What's Included</h3>
            ...
            {/* Table of Contents */}
            <div>
              <h3 className="font-heading font-bold text-xl text-[#1A1A2E] mb-4">Table of Contents</h3>
              <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
                {ebook.tableOfContents.map((item, i) => (
                  <div
                    key={i}
                    className={`flex items-center gap-3 px-5 py-3 ${
                      i !== ebook.tableOfContents.length - 1 ? "border-b border-gray-100" : ""
                    }`}
                  >
